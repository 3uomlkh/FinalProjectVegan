...
public class BookmarkActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bmAdapter.setOnItemClickListener(new BookmarkAdapter.OnItemClickListener() {
            @Override
            public void onItemClick(View view, int pos) {
                //Intent intent = new Intent(this, ItemDetailActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK);
                Intent intent = new Intent(BookmarkActivity.this, ItemDetailActivity.class);
                startActivity(intent);
                //Log.d("b1a2", "해당 아이템 눌림");
            }
